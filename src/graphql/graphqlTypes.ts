...
export interface ExerciseSheetInput {
  name: string;
  maxExercisesPerLevel?: Nullable<number[]>;
...
export interface IMutation {
  ...
  deleteExcelExport(
    exportId: string,
  ): ExcelExportDeleteResult | Promise<ExcelExportDeleteResult>;
  createExerciseCheck(
    data: ExerciseCheckInput,
  ): ExerciseCheck | Promise<ExerciseCheck>;
  ...
  ): ExerciseSheet | Promise<ExerciseSheet>;
  updateExerciseSheet(
    id: string,
  ...
  voteOnDeveloper(
    id: string,
  ): Nullable<Developer> | Promise<Nullable<Developer>>;
...
export interface IQuery {
  ...
  exerciseComment(
    id: string,
  ): Nullable<ExerciseComment> | Promise<Nullable<ExerciseComment>>;
  commentsByExercise(
    id: string,
  ): ExerciseComment[] | Promise<ExerciseComment[]>;
  exerciseSheets(
  ...
  exerciseSheet(
    id: string,
  ): Nullable<ExerciseSheet> | Promise<Nullable<ExerciseSheet>>;
  sameLogicExerciseGroups():
    | SameLogicExerciseGroup[]
    | Promise<SameLogicExerciseGroup[]>;
